                  ...
                  <>
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        {feature.notes && !isExpanded && (
                          <span className="text-xs text-stone-500 italic truncate max-w-48">{feature.notes}</span>
                        )}
                      </div>
                      <div className="flex items-center gap-2">
                        <button
                    ...
                    {isExpanded && (
                      <div className="px-3 pb-3 border-t border-stone-700/50">
                        ...
                        <input
                          ...
                          className="w-full mt-2 bg-stone-900/50 border border-stone-700/50 rounded px-2 py-1 text-xs text-stone-400 focus:outline-none focus:border-amber-700/50"
                        />
                      </div>
                    )}
                  </>
