...
export const FEATS = [
  ...
  { name: 'Alert', category: 'Origin', description: 'Initiative Proficiency: When you roll Initiative, you can add your Proficiency Bonus to the roll. Initiative Swap: Immediately after you roll Initiative, you can swap your Initiative with one willing ally in the same combat. You can\'t do this if you or the ally is Incapacitated.', abilityBoost: { options: ['dex', 'int', 'wis'], amount: 1 } },
  ...
  { name: 'Lucky', category: 'Origin', description: 'Luck Points: You have a number of Luck Points equal to your Proficiency Bonus, regained on Long Rest. When you or a creature you can see within 60 feet makes a d20 Test, you can spend 1 Luck Point to give Advantage or Disadvantage on the roll.', abilityBoost: { options: ['str', 'dex', 'con', 'int', 'wis', 'cha'], amount: 1 } },
  ...
  { name: 'Tough', category: 'Origin', description: 'Hard to Kill: Your Hit Point Maximum increases by an amount equal to twice your character level when you gain this feat. Whenever you gain a level thereafter, your Hit Point Maximum increases by an additional 2 Hit Points.', abilityBoost: { options: ['con'], amount: 1 } },
  ...
  { name: 'Fey Touched', category: 'General', level: 4, description: 'Fey Magic: You learn Misty Step and one 1st-level spell of your choice from the Divination or Enchantment school. You can cast each of these spells once without expending a spell slot, regaining the ability to do so after a Long Rest. You can also cast them using spell slots you have.', abilityBoost: { options: ['int', 'wis', 'cha'], amount: 1 } },
  ...
  { name: 'Great Weapon Master', category: 'General', level: 4, prerequisite: 'STR 13+', description: 'Heavy Weapon Mastery: When you hit with a Heavy weapon as part of the Attack action, deal extra damage equal to your Proficiency Bonus. Hew: Immediately after you score a Critical Hit with a melee weapon or reduce a creature to 0 HP, you can make one melee attack as a Bonus Action.', abilityBoost: { options: ['str'], amount: 1 } },
  ...
  { name: 'Inspiring Leader', category: 'General', level: 4, prerequisite: 'WIS or CHA 13+', description: 'Bolstering Performance: When you finish a Short or Long Rest, you can give an inspiring performance (speech, song, or dance). Choose up to 6 allies within 30 feet who witness it. They each gain Temporary HP equal to your level + the modifier of the ability you increased with this feat.', abilityBoost: { options: ['wis', 'cha'], amount: 1 } },
  ...
  { name: 'Polearm Master', category: 'General', level: 4, prerequisite: 'STR or DEX 13+', description: 'Bonus Attack: After you take the Attack action with a Quarterstaff, Spear, Halberd, Glaive, or Pike, you can make a melee attack with the opposite end as a Bonus Action (deals 1d4 Bludgeoning). Reactive Strike: Enemies provoke Opportunity Attacks from you when they enter your reach.', abilityBoost: { options: ['str', 'dex'], amount: 1 } },
  ...
  { name: 'Sentinel', category: 'General', level: 4, prerequisite: 'STR or DEX 13+', description: 'Guardian: When a creature within 5 feet attacks a target other than you, you can use your Reaction to make a melee attack against that creature. Halt: When you hit with an Opportunity Attack, the target\'s Speed becomes 0 for the rest of the turn.', abilityBoost: { options: ['str', 'dex'], amount: 1 } },
  { name: 'Shadow Touched', category: 'General', level: 4, description: 'Shadow Magic: You learn Invisibility and one 1st-level spell of your choice from the Illusion or Necromancy school. You can cast each of these spells once without expending a spell slot, regaining the ability to do so after a Long Rest. You can also cast them using spell slots you have.', abilityBoost: { options: ['int', 'wis', 'cha'], amount: 1 } },
  { name: 'Sharpshooter', category: 'General', level: 4, prerequisite: 'DEX 13+', description: 'Bypass Cover: Your ranged weapon attacks ignore Half and Three-Quarters Cover. Firing in Melee: Being within 5 feet of an enemy doesn\'t impose Disadvantage on ranged attacks. Long Shots: Attacking at long range doesn\'t impose Disadvantage.', abilityBoost: { options: ['dex'], amount: 1 } },
  ...
  { name: 'War Caster', category: 'General', level: 4, prerequisite: 'Spellcasting feature', description: 'Concentration: You have Advantage on Constitution saving throws to maintain Concentration. Reactive Spell: When a creature provokes an Opportunity Attack from you, you can cast a spell at them (casting time of 1 Action, targeting only that creature) instead of making an attack. Somatic Components: You can perform Somatic components even when holding weapons or a Shield.', abilityBoost: { options: ['int', 'wis', 'cha'], amount: 1 } },
